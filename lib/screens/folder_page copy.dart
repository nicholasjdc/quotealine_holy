...
class _PostListState extends State<PostList> {
  ...
  late Stream<DocumentSnapshot> userFolderStream;
...
/*------------------------------------METHODS---------------------------------*/
  ...
  _filterUserFolders() async {
    ...
    Stream<DocumentSnapshot> tempUserFolderStream =
        Stream.fromIterable(tempCurrentUserFoldersSnaps);
    setState(() {
    ...
    setState(() {
      userFolderStream = tempUserFolderStream;
    });
  }
